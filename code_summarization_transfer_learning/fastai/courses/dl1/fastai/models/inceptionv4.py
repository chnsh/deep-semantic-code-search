...
def load():
    ...
    load_conv2d(state_dict, name_pth='features.10.branch0',
                name_tf='Mixed_6a/Branch_0/Conv2d_1a_3x3')
    load_conv2d(state_dict, name_pth='features.10.branch1.0',
                name_tf='Mixed_6a/Branch_1/Conv2d_0a_1x1')
    load_conv2d(state_dict, name_pth='features.10.branch1.1',
                name_tf='Mixed_6a/Branch_1/Conv2d_0b_3x3')
    load_conv2d(state_dict, name_pth='features.10.branch1.2',

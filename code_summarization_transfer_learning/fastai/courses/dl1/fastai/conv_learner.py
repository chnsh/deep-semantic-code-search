...
class ConvLearner(Learner):
    ...
    @classmethod
    def pretrained(cls, f, data, ps=None, xtra_fc=None, xtra_cut=0, custom_head=None,
                   precompute=False,
    ...
    @classmethod
    def lsuv_learner(cls, f, data, ps=None, xtra_fc=None, xtra_cut=0, custom_head=None,
                     precompute=False,
    ...
    def get_activations(self, force=False):
        ...
        names = [os.path.join(self.tmp_path, p + tmpl) for p in
                 ('x_act', 'x_act_val', 'x_act_test')]
    ...
    def save_fc1(self):
        ...
        self.fc_data = ImageClassifierData.from_arrays(self.data.path,
                                                       (act, self.data.trn_y),
                                                       (val_act, self.data.val_y), self.data.bs,
